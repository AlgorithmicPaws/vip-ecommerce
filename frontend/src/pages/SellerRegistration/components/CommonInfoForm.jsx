    ...
    <div className="common-info-form">
      ...
      <div className="person-type-selection">
        ...
        <div className="radio-group">
          <label className={`radio-option ${data.personType === 'business' ? 'selected' : ''}`}>
            <input
              type="radio"
              name="personType"
              value="business"
            ...
            <div className="radio-content">
              ...
              <div className="radio-text">
                ...
                <span className="radio-description">Empresa constituida legalmente</span>
              </div>
            </div>
          </label>
          
          <label className={`radio-option ${data.personType === 'personal' ? 'selected' : ''}`}>
            <input
              type="radio"
              name="personType"
              value="personal"
        ...
        {errors.personType && <p className="field-error">{errors.personType}</p>}
      </div>
      
      <div className="form-info-note">
        <p>* Campos obligatorios</p>
        <p>
          <strong>Nota:</strong> En la siguiente pantalla solicitaremos la documentación 
